...
class Settings:
    ...
    # SDK-level retries for transient 429/5xx (bounded by the per-call timeout;
    # the interpret ladder's deadline checks still cap total wall time)
    openai_max_retries: int = _get_int("OPENAI_MAX_RETRIES", 1)
