        ...
        with _client_lock:
            if _client is None:
                ...
                kwargs = {
                    ...
                    # one SDK-level retry for transient 429/5xx; each attempt is
                    # still bounded by the per-call timeout, and the interpret
                    # ladder's deadline checks cap the total wall time.
